...
//    public static BandStruct bandStruct = new BandStruct();
    ...
    public static final String ACTION_USB_PERMISSION = "kr.knetz.kddi.app.usb.USB_PERMISSION";
    public static final String ACTION_USB_DETACHED = "android.hardware.usb.action.USB_DEVICE_DETACHED";
    public static final String ACTION_USB_ATTACHED = "android.hardware.usb.action.USB_DEVICE_ATTACHED";
    public static final String SERVICE_NAME = "kr.knetz.kddi.app.v.h.DeviceService";
